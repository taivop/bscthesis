...
\begin{figure}[h]
    \includegraphics[width=0.4\textwidth]{figures/valid_stdp_bpap42.eps}
    \caption{Caption lalala.}
    \label{fig:valid_stdp_bpap42}
\end{figure}

\begin{figure}[h]
    \includegraphics[width=0.4\textwidth]{figures/valid_stdp_bpap100.eps}
    \caption{Caption lalala.}
    \label{fig:valid_stdp_bpap100}
\end{figure}
...
\subsection{Experiment 2 and Experiment 6}
...
\subsection{Experiment 1 and Experiment 5}

\begin{figure}[h]
    \includegraphics[width=0.5\textwidth]{figures/exp1_filter.eps}
    \caption{Caption lalala.}
    \label{fig:exp1filter}
\end{figure}

\begin{figure}[h]
    \includegraphics[width=0.5\textwidth]{figures/exp5_patterncompletion.eps}
    \caption{Caption lalala.}
    \label{fig:exp5patterncompletion}
\end{figure}
