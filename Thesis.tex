...
For uncorrelated Poissonian input of rate $r$, the only effect of PR is to decrease the rate, resulting in an effective input rate $r^* = p \cdot r$. For correlated spiketrains, PR has an effect of destroying correlation in the input. Thus, to study effects of PR not related to input rate, input spike trains must be correlated.
