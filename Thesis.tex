...
In some simulations (TODO which?), learning speed was increased by a factor of 100 by multiplying the values of learning rate $\eta$ and NMDA receptor kinetic constants $k_+$ and $k_-$ by 100. According to \cite{yeung2004synaptic}, it was demonstrated that the fixed points of the system do not change upon speeding up the simulations by this factor.
