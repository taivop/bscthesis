...
\subsection{Selectivity to patterns of input rate} % aka rate code


\subsection{Metaplasticity}

% 9 amplitude values for choosing best mean final weight vs input rate curve.
\begin{figure}[h]
...
%TODO comment iocurve: shape and scale
%TODO comment histogram: shape of final weights
%TODO comment weight rasterplot: scaling down due to metaplasticity, sampled once a second
